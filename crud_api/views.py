...
class AppointmentViewSet(viewsets.ModelViewSet):
    ...
    Handles scheduling and managing appointments between patients and doctors.
    """
    ...
    def get_queryset(self) -> QuerySet:
        """
        Returns filtered queryset of appointments for the authenticated user's patients.
        """
    ...
    def create(self, request: Request, *args: Any, **kwargs: Any) -> Response:
        ...
        if patient.user != request.user:
            return Response(
                {'error': 'You do not have permission to schedule appointments for this patient.'},
                status=status.HTTP_403_FORBIDDEN
            )
    ...
    def update(self, request: Request, *args: Any, **kwargs: Any) -> Response:
        """
        Updates an appointment with ownership validation.
    ...
    def destroy(self, request: Request, *args: Any, **kwargs: Any) -> Response:
        """
        Deletes an appointment with ownership validation.
